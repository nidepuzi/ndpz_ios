...
#define kQuanbuDingdan_URL [NSString stringWithFormat:@"%@/rest/v2/trades?show_sales=1",Root_URL]
#define kWaitpay_List_URL [NSString stringWithFormat:@"%@/rest/v1/trades/waitpay?show_sales=1",Root_URL]
#define kWaitsend_List_URL [NSString stringWithFormat:@"%@/rest/v1/trades/waitsend?show_sales=1",Root_URL]
...
#define UPDATE_URLSTRING [NSString stringWithFormat:@"https://itunes.apple.com/lookup?id=%@",@"1221193673"]
