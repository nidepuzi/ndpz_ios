...
- (void)createTableView {
    self.tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 64, TabWidth, SCREENHEIGHT - 64) style:UITableViewStylePlain];
...
- (void)createCollectionView {
    ...
    self.collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(TabWidth, 64, ColWidth, SCREENHEIGHT - 64) collectionViewLayout:layout];
