...
- (void)createInputBoxView {
    UIView *textFieldView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, SCREENWIDTH, 330)];
    ...
    UITextField *consigneeField = [self createTextFieldWithFrame:CGRectMake(20, 10, SCREENWIDTH - 40, 40) PlaceHolder:@"收货人姓名" KeyboardType:UIKeyboardTypeDefault];
    UITextField *phoneNumField = [self createTextFieldWithFrame:CGRectMake(20, consigneeField.cs_max_Y + 20, SCREENWIDTH - 40, 40) PlaceHolder:@"手机号" KeyboardType:UIKeyboardTypeNumberPad];
    UITextField *idCardField = [self createTextFieldWithFrame:CGRectMake(20, phoneNumField.cs_max_Y + 20, SCREENWIDTH - 40, 40) PlaceHolder:@"身份证: (可选填,购买保税商品必填)" KeyboardType:UIKeyboardTypeNumbersAndPunctuation];
    UITextField *areaField = [self createTextFieldWithFrame:CGRectMake(20, idCardField.cs_max_Y + 20, SCREENWIDTH - 40, 40) PlaceHolder:@"省 市 区" KeyboardType:UIKeyboardTypeDefault];
    self.consigneeField = consigneeField;
    self.phoneNumField = phoneNumField;
    self.idCardField = idCardField;
    self.areaField = areaField;
    [textFieldView addSubview:consigneeField];
    [textFieldView addSubview:phoneNumField];
    [textFieldView addSubview:idCardField];
    [textFieldView addSubview:areaField];
    
    UITextView *addressTextView = [[UITextView alloc] initWithFrame:CGRectMake(20, areaField.cs_max_Y + 20, SCREENWIDTH - 40, 80)];
    ...
    [textFieldView addSubview:addressTextView];
...
//    [addressTextView setValue:placeHolderLabel forKey:@"_placeholderLabel"];
    ...
    UIView *settingView = [[UIView alloc] initWithFrame:CGRectMake(0, addressTextView.cs_max_Y + 20, SCREENWIDTH, 40)];
    settingView.backgroundColor = [UIColor whiteColor];
    [self.maskScrollView addSubview:settingView];
    
    UILabel *isSettingLabel = [self createLabelWithFrame:CGRectMake(20, 0, SCREENWIDTH / 2, 40) font:13. textColor:[UIColor buttonTitleColor] text:@"设为默认地址"];
    ...
    if (self.orderEditAddress) {
        ...
        if (!self.isAdd) {
            UIButton *deleateView = [[UIButton alloc] initWithFrame:CGRectMake(0, settingView.cs_max_Y + 20, SCREENWIDTH, 40)];
            deleateView.backgroundColor = [UIColor whiteColor];
            [self.maskScrollView addSubview:deleateView];
            [deleateView addTarget:self action:@selector(rightNavigationClick:) forControlEvents:UIControlEventTouchUpInside];
            
            UILabel *deleateLabel = [self createLabelWithFrame:CGRectMake(20, 0, SCREENWIDTH / 2, 40) font:13. textColor:[UIColor buttonEnabledBackgroundColor] text:@"删除"];
            [deleateView addSubview:deleateLabel];
        }else {
            settingViewH = 0.f;
        }
    }
    ...
    UILabel *warningLabel = [self createLabelWithFrame:CGRectMake(20, settingView.cs_max_Y + 20 + settingViewH, SCREENWIDTH - 40, 20) font:14. textColor:[UIColor redColor] text:@""];
