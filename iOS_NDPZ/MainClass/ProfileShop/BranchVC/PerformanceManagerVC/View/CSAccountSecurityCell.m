...
- (void)configPerformanceManager:(NSDictionary *)itemDic Index:(NSInteger)index {
    self.settingDescTitleLabel.textColor = index == 0 ? [UIColor buttonEnabledBackgroundColor] : [UIColor dingfanxiangqingColor];
    self.settingTitleLabel.text = itemDic[@"title"];
    self.settingDescTitleLabel.text = itemDic[@"descTitle"];
    self.cellImageView.image = [UIImage imageNamed:itemDic[@"cellImage"]];
