...
- (void)sureButtonClick:(UIButton *)button {
    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"兑换提示" message:@"兑换此现金券后，你的铺子账户余额会相应扣减金额，此现金券能够用于商城购买商品，无法取消" delegate:self cancelButtonTitle:@"取消" otherButtonTitles:@"确定", nil];
    alertView.tag = 100;
    [alertView show];
