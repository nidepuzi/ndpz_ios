...
- (void)createWithdraw {
    ...
    self.blanceLabel.text = @"你的铺子账户余额：";
    ...
    xiaoluBackImage.image = [UIImage imageNamed:@"cs_yuanquan_nomal"];//circle_wallet_Selected@2x -- 高亮
...
- (void)withdrawToWallet:(UIButton *)button {
    UIImage *nomalImage = [UIImage imageNamed:@"cs_yuanquan_nomal"];
    UIImage *selecterImage = [UIImage imageNamed:@"cs_yuanquan_selected"];
    if (button.tag == 200) {
