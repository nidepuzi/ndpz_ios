...
- (void)setCartModel:(CartListModel *)cartModel {
    ...
    [self.iconImage sd_setImageWithURL:[NSURL URLWithString:[[cartModel.pic_path imageGoodsOrderCompression] JMUrlEncodedString]] placeholderImage:[UIImage imageNamed:@"icon_placeholderEmpty"]];
