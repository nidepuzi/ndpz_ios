...
- (void)viewDidLoad {
    ...
    [button setImage:[UIImage imageNamed:@"order_hideSetting"] forState:UIControlStateNormal];
    [button setImage:[UIImage imageNamed:@"order_showSetting"] forState:UIControlStateSelected];
