...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    if ([self.refundModelr.pic_path isKindOfClass:[NSString class]] ) {
        [iconImage sd_setImageWithURL:[NSURL URLWithString:[self.refundModelr.pic_path JMUrlEncodedString]] placeholderImage:[UIImage imageNamed:@"icon_placeholderEmpty"]];
