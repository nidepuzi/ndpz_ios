...
-(void)configureViews
{
    ...
    UIColor *tintColor = [UIColor colorWithR:10 G:169 B:188 alpha:1];//[UIColor colorWithRed:22.f / 255.f green:126.f / 255.f blue:251.f / 255.f alpha:1.0]; // iOS7 Safari bar color
