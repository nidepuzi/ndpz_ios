...
//    self.leveModel = [JMLevelinfoModel mj_objectWithKeyValues:dic];
    ...
    [self.iconImage sd_setImageWithURL:[NSURL URLWithString:[[model.pic_path imageGoodsOrderCompression] JMUrlEncodedString]] placeholderImage:[UIImage imageNamed:@"icon_placeholderEmpty"]];
...
//    self.leveModel = [JMLevelinfoModel mj_objectWithKeyValues:dic];
    ...
    [self.iconImage sd_setImageWithURL:[NSURL URLWithString:[[product.pic_path imageGoodsOrderCompression] JMUrlEncodedString]] placeholderImage:[UIImage imageNamed:@"icon_placeholderEmpty"]];
    self.iconImage.contentMode = UIViewContentModeScaleAspectFill;
