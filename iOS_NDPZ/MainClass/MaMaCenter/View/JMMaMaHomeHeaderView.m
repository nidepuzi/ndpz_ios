...
//    NSDictionary *extraFiguresDic = self.centerModel.extra_figures;
    if (self.extraModel.thumbnail != nil) {  // 妈妈头像
        [self.iconImage sd_setImageWithURL:[NSURL URLWithString:[self.extraModel.thumbnail JMUrlEncodedString]] placeholderImage:[UIImage imageNamed:@"icon_placeholderEmpty"]];
    }
...
- (void)setUserInfoDic:(NSDictionary *)userInfoDic {
    ...
    if (_userInfoDic != nil) {
        ...
        [self.iconImage sd_setImageWithURL:[NSURL URLWithString:[userInfoDic objectForKey:@"thumbnail"]] placeholderImage:[UIImage imageNamed:@"icon_placeholderEmpty"]];
...
//    self.couponLabel = (UILabel *)[self viewWithTag:12];
    ...
    UIView *wodeOrder = [[UIView alloc] initWithFrame:CGRectMake(0, _topImageView.cs_max_Y, SCREENWIDTH, itemSizeWidth + 20)];
...
//    [wodeOrder addSubview:orderSectionView];
    ...
    UIView *wodedianpuView = [[UIView alloc] initWithFrame:CGRectMake(0, wodeOrder.cs_max_Y + 15, SCREENWIDTH, 425)];
...
//    [wodedianpuView addSubview:wodedianpuSectionView];
    ...
    UIView *selectBoxView2 = [[UIView alloc] initWithFrame:CGRectMake(0, selectBoxView.cs_max_Y + 15, SCREENWIDTH, 130)];
