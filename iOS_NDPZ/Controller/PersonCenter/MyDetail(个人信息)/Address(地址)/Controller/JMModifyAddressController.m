...
- (void)createNavRightItem {
    ...
    [self.navRightButton setTitleColor:[UIColor buttonEnabledBackgroundColor] forState:UIControlStateNormal];
...
- (void)createInputBoxView {
    ...
    UILabel *phoneNumLabel = [self createLabelWithFrame:CGRectMake(20, consigneeLabel.cs_max_Y, labelWidth * HomeCategoryRatio, 40) font:13. textColor:[UIColor buttonTitleColor] text:@"手机号"];
    UITextField *consigneeField = [self createTextFieldWithFrame:CGRectMake(labelWidth * HomeCategoryRatio + 20, 15, SCREENWIDTH - consigneeLabel.cs_max_X - 20, 30) PlaceHolder:@"请输入收货人姓名" KeyboardType:UIKeyboardTypeDefault];
    UITextField *phoneNumField = [self createTextFieldWithFrame:CGRectMake(labelWidth * HomeCategoryRatio + 20, consigneeField.cs_max_Y + 10, SCREENWIDTH - consigneeLabel.cs_max_X - 20, 30) PlaceHolder:@"请输入收货人手机号" KeyboardType:UIKeyboardTypeNumberPad];
    ...
    if (self.cartsPayInfoLevel > 1) {
        UILabel *idCardLabel = [self createLabelWithFrame:CGRectMake(20, phoneNumLabel.cs_max_Y, labelWidth * HomeCategoryRatio, 40) font:13. textColor:[UIColor buttonTitleColor] text:@"身份证号"];
            UITextField *idCardField = [self createTextFieldWithFrame:CGRectMake(labelWidth * HomeCategoryRatio + 20, phoneNumField.cs_max_Y + 10, SCREENWIDTH - consigneeLabel.cs_max_X - 20, 30) PlaceHolder:@"请输入身份证号" KeyboardType:UIKeyboardTypeNumbersAndPunctuation];
        self.idCardField = idCardField;
        [firstSectionView addSubview:idCardLabel];
        [firstSectionView addSubview:idCardField];
    }
    
    UIView *secondSectionView = [[UIView alloc] initWithFrame:CGRectMake(0, firstSectionView.cs_max_Y + 20, SCREENWIDTH, 150)];
    ...
    UILabel *addressLabel = [self createLabelWithFrame:CGRectMake(20, areaLabel.cs_max_Y, labelWidth * HomeCategoryRatio, 40) font:13. textColor:[UIColor buttonTitleColor] text:@"详细地址"];
    UITextField *areaField = [self createTextFieldWithFrame:CGRectMake(labelWidth * HomeCategoryRatio + 20, 15, SCREENWIDTH - consigneeLabel.cs_max_X - 20, 30) PlaceHolder:@"请选择您所在地区" KeyboardType:UIKeyboardTypeDefault];
...
//        NSLog(@"%d : %@",i , objcName);
//    }
    UITextView *addressTextView = [[UITextView alloc] initWithFrame:CGRectMake(labelWidth * HomeCategoryRatio + 20, areaField.cs_max_Y + 10, SCREENWIDTH - consigneeLabel.cs_max_X - 20, 80)];
...
//    [addressTextView setValue:placeHolderLabel forKey:@"_placeholderLabel"];
    ...
    if (self.isAdd || self.orderEditAddress) {
        ...
        UIView *settingView = [[UIView alloc] initWithFrame:CGRectMake(0, secondSectionView.cs_max_Y + 20, SCREENWIDTH, 40)];
    ...
    UILabel *warningLabel = [self createLabelWithFrame:CGRectMake(20, secondSectionView.cs_max_Y + 20 + settingViewH, SCREENWIDTH - 40, 20) font:14. textColor:[UIColor redColor] text:@""];
    [self.maskScrollView addSubview:warningLabel];
    self.warningLabel = warningLabel;
    
    UIButton *againUpdatabutton = [UIButton buttonWithType:UIButtonTypeCustom];
    againUpdatabutton.frame = CGRectMake(15, warningLabel.cs_max_Y + 10, SCREENWIDTH - 30, 40);
    ...
    idCardView.frame = CGRectMake(0, againUpdatabutton.cs_max_Y + 10, SCREENWIDTH, 110);
...
//    _sideBackLabel.text = @"请上传身份证\n反面照";
    ...
    savebutton.frame = CGRectMake(15, warningLabel.cs_max_Y + 10 + idcardViewHeiht, SCREENWIDTH - 30, 40);
...
- (void)againUpdatabuttonClick:(UIButton *)button {
    ...
    if (button.selected) {
        ...
        self.maskScrollView.contentSize = CGSizeMake(SCREENWIDTH, self.savebutton.cs_max_Y + 20);
    }else {
        self.idCardView.hidden = YES;
        self.idCardView.cs_h = 0.f;
        self.savebutton.cs_y = self.idCardView.cs_max_Y + 10;
