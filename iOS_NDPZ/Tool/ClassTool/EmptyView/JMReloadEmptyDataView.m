...
- (void)layoutSubviews {
    ...
    rectLabel.origin.y = self.emptyImageView.cs_max_Y + 10;
    rectLabel.size = CGSizeMake(SCREENWIDTH, 20);
    self.emptyTitleLabel.frame = rectLabel;
    self.emptyTitleLabel.cs_centerX = self.emptyImageView.cs_centerX;
    
    
    CGRect rectDescLabel = CGRectZero ;
    rectDescLabel.origin.x = 0.f;
    rectDescLabel.origin.y = self.emptyTitleLabel.cs_max_Y + 10;
    rectDescLabel.size = CGSizeMake(SCREENWIDTH, 20);
    self.emptyDescTitleLabel.frame = rectDescLabel;
    self.emptyDescTitleLabel.cs_centerX = self.emptyImageView.cs_centerX;
    ...
    if (self.emptyButton) {
        ...
        rectButton.origin.y = self.emptyDescTitleLabel.cs_max_Y + 10;
        rectButton.size = CGSizeMake(infoStringW + 30, infoStringH * 2) ;
        self.emptyButton.frame = rectButton ;
        self.emptyButton.cs_centerX = self.emptyImageView.cs_centerX;
    }
